...
public class CSVUtils {
    ...
    private static HashMap<String, String> mapCSVTestData(int selectedProfileRow, String filePath) {
        ...
        try {
            ...
            throw new RuntimeException("Exception happened reading the csv file");
        }
        return testDataMap;
    ...
    public static HashMap<String, String> mapCSVTestData(String file, String columnName1, String columnName2) {
        ...
        try {
            ...
            if (!columnsFound)
                throw new RuntimeException("The column names are not found in the file " + file);
    ...
    public static int getRowCount(String file) {
        ...
        if (size == 0)
            throw new RuntimeException("There are no lines in the csv file located at " + file);
        return size;
    ...
    public static List<String> getColumnData(String file, String ColumnName) {
        ...
        try {
            ...
            if(!columnFound)
            throw new RuntimeException("The column name " + ColumnName + " is not found in the file " + file);
