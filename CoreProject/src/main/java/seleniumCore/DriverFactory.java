...
public class DriverFactory {
        ...
        try {
            if (System.getProperty(CoreProperties.platform).equalsIgnoreCase(OSType.APP.toString())) {
                ...
                if (browser.equalsIgnoreCase(CoreConstants.firefox)) {
                    ...
                    throw new RuntimeException("Please choose a web browser to run a test");
            } else {
                throw new RuntimeException("Please choose a valid Platform  , either APP or WEB");
            }
        } catch (Exception e) {
            Log.warn("Exception Happened in Hub node configuration");
            e.printStackTrace();
            throw new RuntimeException("Check the hub node configuration");
        }
    }
    ...
    private static synchronized void setLocalDriver(String browser) {
        ...
        if (browser.equals("firefox")) {
            ...
            throw new RuntimeException("Unable to create a driver");
        }
