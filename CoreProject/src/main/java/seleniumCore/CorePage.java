...
public class CorePage {
    ...
    protected void uploadFileByAutoIT(String fileLocation) {
        ...
        if (verifyFileExists(CoreConstants.pathToAutoITChrome + fileLocation)) {
            ...
            try {
                ...
                throw new RuntimeException("Exception happened while uploading a file using AUTOIT " + e.getMessage());
            }
        } else
            throw new RuntimeException("The autoit file  was not found at the location : " + fileLocation);
    ...
    private String getWindowUploadName() {
        ...
        if (browser.contains("chrome"))
            ...
            throw new RuntimeException("Supporting Chome, edge and firefox as of now., Please contact Taqueem");
        return winTitle;
    }
    ...
    private static FluentWait waitForCondition() {
        ...
        return (new FluentWait(driver, Clock.systemDefaultZone(), Sleeper.SYSTEM_SLEEPER)).withTimeout(Duration.ofSeconds(seconds)).
...
/*    public Wait<WebDriver> waitForCondition() {
    ...
    protected static void waitTillAllVisible(List<WebElement> elements) {
    ...
    public static void switchToAngularIFrame(WebElement frameAngular) {
        ...
        if (isElementPresent(frameAngular)) {
            ...
            driver.switchTo().frame(frameAngular);
...
//        logger.info("returning " + isElementEnabled + " from  isElementEnabled for the element :  " + element);
    ...
    protected WebElement findOnException(String firstXpath, String secondXpath) {
        ...
        try {
            ...
            throw new RuntimeException("The element is not found");
        }
        return element;
    }
    ...
    protected boolean isStringListSorted(List<String> list, CompareMode mode) {
        ...
        switch (mode) {
            ...
            case DESCENDING:
                ...
                break;
            default:
                throw new RuntimeException("The Comparison method is not defined.");
        }
        return isSorted;
    }
